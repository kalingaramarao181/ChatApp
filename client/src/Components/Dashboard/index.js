            ...
            <div className='dashboard-total-container'>
                <div className='dashboard-main-container'>
                    ...
                    {chatUsersData.map(eachUser => {
                        return (
                            <button  onClick={() => onClickSendUser(eachUser.id)} className={eachUser.id === message.receiverid ? 'dashboard-profil-container-3': 'dashboard-profil-container-2'}>
